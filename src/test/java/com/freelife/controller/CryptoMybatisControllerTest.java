 ...
 */
@Transactional
public class CryptoMybatisControllerTest extends BaseTest {

    public CryptoMybatisControllerTest(WebApplicationContext ctx) {
        super(ctx);
    }

    private final String prefix = "/mybatis";

    // @Autowired
    // @Qualifier("memberMybatisService")
    @Resource(name = "cryptoMybatisService")
    private CryptoPerformanceService cryptoService;
    ...
    @Test
    @Order(1)
    @DisplayName("POST: Mybatis 회원 추가 테스트")
    void saveMember() throws Exception {
        totalStopWatch.start("POST: Mybatis 회원 추가");
    ...
    @Test
    @Order(2)
    @DisplayName("GET: Mybatis 회원 조회 테스트")
    void selectMember() throws Exception {
        totalStopWatch.start("GET: Mybatis 회원 조회");
    ...
    @Test
    @Order(3)
    @DisplayName("PUT: Mybatis 회원 수정 테스트")
    void updateMember() throws Exception {
        totalStopWatch.start("PUT: Mybatis 회원 수정");
    ...
    @Test
    @Order(4)
    @DisplayName("DELETE: Mybatis 회원 삭제 테스트")
    void deleteMember() throws Exception {
        totalStopWatch.start("DELETE: Mybatis 회원 삭제");
