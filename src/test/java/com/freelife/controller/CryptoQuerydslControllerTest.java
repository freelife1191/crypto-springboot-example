 ...
 */
@Transactional
public class CryptoQuerydslControllerTest extends BaseTest {

    public CryptoQuerydslControllerTest(WebApplicationContext ctx) {
        super(ctx);
    }

    private final String prefix = "/querydsl";

    // @Autowired
    // @Qualifier("memberQuerydslService")
    @Resource(name = "cryptoQuerydslService")
    ...
    @Test
    @Order(1)
    @DisplayName("POST: Querydsl 회원 추가 테스트")
    void saveMember() throws Exception {
        totalStopWatch.start("POST: Querydsl 회원 추가");
    ...
    @Test
    @Order(2)
    @DisplayName("GET: Querydsl 회원 조회 테스트")
    void selectMember() throws Exception {
        totalStopWatch.start("GET: Querydsl 회원 조회");
    ...
    @Test
    @Order(3)
    @DisplayName("PUT: Querydsl 회원 수정 테스트")
    void updateMember() throws Exception {
        totalStopWatch.start("PUT: Querydsl 회원 수정");
    ...
    @Test
    @Order(4)
    @DisplayName("DELETE: Querydsl 회원 삭제 테스트")
    void deleteMember() throws Exception {
        totalStopWatch.start("DELETE: Querydsl 회원 삭제");
