...
@AllArgsConstructor
@Builder
public class ResponseMemberNoEncDto {
    ...
    public static ResponseMemberNoEncDto fromEntity(MemberNoEnc member) {
        return ResponseMemberNoEncDto.builder()
                .id(member.getId())
                .name(member.getName())
    ...
    public ResponseMemberNoEncDto setEncPassword(String encPassword) {
