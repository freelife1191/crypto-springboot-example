...
import com.freelife.repository.mybatis.MemberOracleFunctionMapper;
...
@Transactional
public class CryptoMybatisOracleFunctionService implements CryptoFunctionService {

    private final MemberOracleFunctionMapper memberMapper;
